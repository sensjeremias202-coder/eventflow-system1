...
function submitRating() {
    ...
    if (!rating || rating < 1 || rating > 5) {
        showNotification('Por favor, selecione uma avalia��o de 1 a 5 estrelas', 'error');
        return;
    }
    ...
    if (existingIdx !== -1) {
        ...
        showNotification('Avalia��o atualizada com sucesso!', 'success');
    } else {
        // Nova avalia��o
        events[eventIdx].ratings.push(ratingData);
        showNotification('Avalia��o enviada com sucesso!', 'success');
    }
